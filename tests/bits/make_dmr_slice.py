...
Polarity is committed here, before mslice hard-slices: this capture's sync pattern
correlates at native polarity, so the IQ is written un-conjugated. If the gate finds
no syncs on a re-derived capture, wrap the IQ in np.conjugate to flip every dibit."""
